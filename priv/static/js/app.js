...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"my-app"},[_c('h1',[_vm._v("Vuechat")]),_vm._v(" "),_vm._l((_vm.messages),function(message){return _c('ul',[_c('li',[_c('small',[_vm._v(_vm._s(message.received_at))]),_vm._v(": "+_vm._s(message.body)+"\n    ")])])}),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.message),expression:"message"}],attrs:{"type":"text"},domProps:{"value":(_vm.message)},on:{"keyup":function($event){if(!('button' in $event)&&$event.keyCode!==13){ return null; }return _vm.sendMessage($event)},"input":function($event){if($event.target.composing){ return; }_vm.message=$event.target.value}}})],2)}
...
new _vue2.default({
  ...
  mounted: function mounted() {
    ...
    this.channel.on("new_msg", function (payload) {
